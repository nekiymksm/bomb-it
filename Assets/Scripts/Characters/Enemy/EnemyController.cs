...
public class EnemyController : MonoBehaviour
{
    ...
    private void Move()
    {
        var horizontalLevelLimit = _level.LevelItemsDirector.Ground.transform.localScale.x / 2;
        var verticalLevelLimit = _level.LevelItemsDirector.Ground.transform.localScale.z / 2;
